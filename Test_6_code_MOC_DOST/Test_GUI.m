...
COM=evalin('base','COM');
[Class1,Class1_raw]=acquireData(COM);
assignin('base','Class1',Class1);
assignin('base','Class1_raw',Class1_raw);
...
set(hObject,'BackgroundColor','red');
COM=evalin('base','COM');
[Class2,Class2_raw]=acquireData(COM);
assignin('base','Class2',Class2);
assignin('base','Class2_raw',Class2_raw);
set(hObject,'BackgroundColor','green');
...
set(hObject,'BackgroundColor','red');
COM=evalin('base','COM');
[Class3,Class3_raw]=acquireData(COM);
assignin('base','Class3',Class3);
assignin('base','Class3_raw',Class3_raw);
set(hObject,'BackgroundColor','green');
...
set(hObject,'BackgroundColor','red');
COM=evalin('base','COM');
[Class4,Class4_raw]=acquireData(COM);
assignin('base','Class4',Class4);
assignin('base','Class4_raw',Class4_raw);
set(hObject,'BackgroundColor','green');
