...
%      app lied to the GUI before Test_GUI_OpeningFcn gets called.  An
...
Training_samples=evalin('base','Training_samples');
Class1=acquireData(COM,Training_samples,Channel_length);
...
Channel_length=evalin('base','Channel_length');
Training_samples=evalin('base','Training_samples');
Class2=acquireData(COM,Training_samples,Channel_length);
...
Channel_length=evalin('base','Channel_length');
Training_samples=evalin('base','Training_samples');
Class3=acquireData(COM,Training_samples,Channel_length);
...
Channel_length=evalin('base','Channel_length');
Training_samples=evalin('base','Training_samples');
Class4=acquireData(COM,Training_samples,Channel_length);
...
Hd=evalin('base','Hd');
COM=evalin('base','COM');
rawData=acquireData(COM,Test_samples,Channel_length);
